...
-- Dumping database structure for bpts1
CREATE DATABASE IF NOT EXISTS `bpts1` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `bpts1`;

-- Dumping structure for table bpts1.contestants
...
-- Dumping data for table bpts1.contestants: ~35 rows (approximately)
...
-- Dumping structure for table bpts1.criteria
...
-- Dumping data for table bpts1.criteria: ~10 rows (approximately)
...
-- Dumping structure for table bpts1.levels
...
-- Dumping data for table bpts1.levels: ~4 rows (approximately)
...
-- Dumping structure for table bpts1.score
...
-- Dumping data for table bpts1.score: ~0 rows (approximately)
/*!40000 ALTER TABLE `score` DISABLE KEYS */;
/*!40000 ALTER TABLE `score` ENABLE KEYS */;

-- Dumping structure for table bpts1.swimsuit
...
-- Dumping data for table bpts1.swimsuit: ~35 rows (approximately)
...
-- Dumping structure for table bpts1.users
...
-- Dumping data for table bpts1.users: ~11 rows (approximately)
...
-- Dumping structure for table bpts1.user_type
CREATE TABLE IF NOT EXISTS `user_type` (
  `user_type_id` int(11) DEFAULT NULL,
  `user_type` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table bpts1.user_type: ~2 rows (approximately)
...
-- Dumping structure for table bpts1.winners
...
-- Dumping data for table bpts1.winners: ~0 rows (approximately)
