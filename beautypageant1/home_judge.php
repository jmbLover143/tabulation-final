...
<body class="fixed-sn light-blue-skin" onload="$('#score').focus();$('#score6').focus();">
    ...
    <center>
        ...
        <img src="lib/images/ACLC LOGO2.png" width="130px" style="margin: 5px; height: 45px; box-shadow: 0px 0px 10px #fff;">
                ...
                <div class="row">
                    <div class="col-6 col-md-6 col-lg-6">
                        ...
                        <div class="card card-cascade wider">
                            ...
                            <div style="">
                                <center>                           
                                <img class="" src="lib/img/Headshot/<?php echo $contestant_picture; ?>" style="height: 70vh;width: 380px;border: 1px solid black; " alt="Card image cap">
                                </center>
                                <a href="#!">
...
<button type="button" name="submit_button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalCenter">
  Submit score</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Miss Marikina 2018</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <h5 class="modal-title" id="exampleModalLongTitle">Are you sure you want to submit score ?</h5>
      </div>
      <div class="modal-footer">
       <input class="btn btn-primary" type="submit" name="submit_button" style="margin-top: 50px;background-color:#33BEFF; padding: 15px 35px; font-size: 130%;">
              <input class="btn btn-danger" data-dismiss="modal"   value="Change score" style="margin-top: 50px; padding: 15px 35px; font-size: 130%;">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
                                        <input type="submit" name="submit_button" class="btn btn-danger" style="background-color:#33BEFF;margin-top: 50px; padding: 15px 35px; font-size: 130%;" value="Submit">
              <input class="btn btn-primary" data-dismiss="modal"   value="Change score" style="margin-top: 50px; padding: 15px 35px; font-size: 130%;">
                                    ...
                                    if(mysqli_num_rows($result) > 0)
                                    {
                                        ...
                                        $output2 .= '<div class="col-lg-12 col-md-12 col-12">
                                                        <center>
                                                        <!-- Button trigger modal -->
<button type="button" name="submit_button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalCenter">
  Submit score</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
                    ...
                    <input class="btn btn-primary" data-dismiss="modal"   value="Change score" style="margin-top: 50px; padding: 15px 35px; font-size: 130%;">
                                                 <input type="submit" name="submit_buttonn" class="btn btn-danger" style="width: 100%; margin-top: 30px; padding: 15px 35px; font-size: 130%;background-color:#33BEFF;" value="Submit"></div>
