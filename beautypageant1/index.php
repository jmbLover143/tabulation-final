  ...
  <div class="topLayer">
    <div class="left">
      <div class="content">
        ...
        <br><br>
        <img src="lib/images/ACLC LOGO2.png" alt="" width="60%;" style="height: 20vh; float: left;">
    ...
    <div class="right">
      <div class="content">
        <h2 class="text-center" style="margin: 0px; font-size: 400%; font-weight: 100; text-align: left;">Judge</h2>
          ...
          <br><br>
          <img src="lib/images/ACLC LOGO orig_1.png" alt="" width="60%;" style="height: 20vh; float: left;">
